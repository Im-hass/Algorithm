...
public class Main_G4_1043_거짓말 {
  ...
  public static void main(String[] args) throws IOException {
    ...
    for (int i = 0; i < M; i++) {
      partyRoots[i] = setParty(in);
    }

    int answer = countLies(truth, partyRoots, truthRoots);
    System.out.println(answer);
  }

  public static int setParty(BufferedReader in) throws IOException {
    StringTokenizer st = new StringTokenizer(in.readLine());
  ...
  public static int countLies(int truth, int[] partyRoots, int[] truthRoots) {
    int answer = partyRoots.length; // 거짓말할 수 있는 파티의 수
